...
The `third_party` directory contains all third party software and content under
its own license. Each subdirectory contains a `LICENSE`, `LICENSE.txt`, or
`LICENSE.md` containing the specific license and restrictions which apply to
that subdirectory.
