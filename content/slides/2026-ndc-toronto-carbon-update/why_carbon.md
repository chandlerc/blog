...
## Announced Carbon 4 years ago here in Toronto
...
- _Incredibly_ slow compile times and ever-growing complexity
- Macros still built with the C preprocessor
- No type-checked generics system
- No package manager
- Memory unsafe and riddled with undefined behavior and footguns
- ...
...
## And has become an existential risk...
...
- Adding memory safety to existing software
- Improving compile times by 10x
- Generating smaller, faster binaries
